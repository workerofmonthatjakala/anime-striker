...
data class GameState(
    ...
    val availableJobs: List<GameJob> = listOf(
        GameJob(1, Level(1, 10.gelds, 1.gelds, 1.seconds), "schattendoppelgängger"),
        GameJob(2, Level(1, 50.gelds, 10.gelds, 10.seconds), "rasengan"),
        GameJob(3, Level(1, 250.gelds, 50.gelds, 30.seconds), "sasuke"),
        GameJob(4, Level(1, 500.gelds, 250.gelds, 60.seconds), "kakashi"),
        GameJob(5, Level(1, 1000.gelds, 500.gelds, 120.seconds), "minato")
